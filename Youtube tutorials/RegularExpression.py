...
# You can compile a regex pattern into a regex object4 which
# provide additional methods like match() and search()
...
emailList = 'db@aol.com m@.com @apple.com db@.com  abdalla.elnaggar@ericsson.com'
